public class PhraseTester {
    ...
    public static void main(String[] args) {
        ...
        Phrase test = new Phrase("A cat ate late.");
        System.out.println(test.findNthOccurrence("at", 1));
        System.out.println(test.findNthOccurrence("at", 2));
        System.out.println(test.findNthOccurrence("at", 3));
        System.out.println(test.findNthOccurrence("at", 4));
        System.out.println(test.findNthOccurrence("bat", 1));
        ...
        System.out.println(phrase6.findLastOccurrence("te."));
    }
}
